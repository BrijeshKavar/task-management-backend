...
class XacmlClass {
  ...
  constructor({ pre, validation, secondaryValidations, preRequest }: Construct) {
    this.pre = pre as Pre[];
    this.validation = validation;
    this.preRequest = preRequest;
    this.secondaryValidations = secondaryValidations as SecondaryValidation[];
  }
